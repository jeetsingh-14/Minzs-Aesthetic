                  ...
                  <motion.div variants={staggerContainer}>
                    ...
                    >
                      ...
                      <a 
                        ...
                        className="bg-[#A17C6B] text-white px-8 py-4 rounded-full font-body text-sm uppercase tracking-widest shadow-soft hover:shadow-glow hover:bg-[#5A4B41] transition-all duration-300 flex items-center justify-center min-w-[140px]"
                      >
