  ...
  return (
    <div className="fixed bottom-4 sm:bottom-6 md:bottom-8 right-4 sm:right-6 md:right-8 z-50">
      ...
      >
        ...
        <motion.div 
          className="flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-whatsApp rounded-full shadow-soft hover:shadow-glow transition-all duration-300"
        ...
        >
          <svg 
            ...
            viewBox="0 0 24 24" 
            className="w-6 h-6 sm:w-8 sm:h-8 fill-pureWhite"
          >
